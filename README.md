...
Este projeto foi criado para oferecer uma documentação web mais organizada, navegável e fácil de manter.

A proposta é centralizar:

- instruções para participantes;
- tutoriais práticos;
- solução de erros frequentes;
- materiais de apoio para consulta rápida.
